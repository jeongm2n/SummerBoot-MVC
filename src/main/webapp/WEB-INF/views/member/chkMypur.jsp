								    			...
								    			<th colspan="4" style="vertical-align:middle;border-top: 2px solid gray;">
								    				<div class=row style="padding-left:2%;padding-right:2%;">
														...
														<div class="col-2" style="text-align:right;">
															...
															<!-- <button class="btn_popup"></button> -->
														</div>
														<%-- <c:if test="${review == null && list.status != '배송 완료'}">
															<div class="col-1">
																<button type="button" class="review_btn text-decoration-line-through" style="font-size:12pt" disabled>리뷰 작성</button>
															</div>
														</c:if> --%>
													</div>
												</th>
						    		...
						    		<tbody class="tbody2" style="vertical-align:middle;border-bottom: 1.7px solid #F4EEEE;">
						    			<tr>
						    				...
						    				<td class="col-3" style="text-align:center;">
												<c:choose>
													<c:when test="${list.status eq 'paid'}">
												   		<h4 style="color: salmon;">결제 완료</h4>
												  	</c:when>
													...
													<c:when test="${list.status eq 'cancelled'}">
														<h4 style="color: grey;">결제 취소</h4>
													</c:when>
													<c:when test="${list.status eq '취소 요청'}">
												  		<h4 style="color: darkgrey;">취소 요청</h4>
													</c:when>
												</c:choose>
						    				</td>
											<td class="col-2 button-line">
												...
												<c:if test="${list.status eq '배송 준비중' || list.status eq 'paid' || list.status eq 'ready'}">
													<div style="margin-bottom:1%;">
