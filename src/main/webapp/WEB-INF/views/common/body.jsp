        ...
        <section class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 pb-5">
                    <a data-bs-toggle="collapse" role="button" href="#res_seoul" aria-expanded="false"
                       aria-controls="res_seoul"
                ...
                <div class="col-md-6 col-lg-3 pb-5">
                    <a data-bs-toggle="collapse" role="button" href="#res_gunpo" aria-expanded="false"
                       aria-controls="res_gunpo"
                ...
                <div class="col-md-6 col-lg-3 pb-5">
                    <a data-bs-toggle="collapse" role="button" href="#res_daegu" aria-expanded="false"
                       aria-controls="res_daegu"
            ...
            function getTodayResList(todayres) {
                ...
                $.ajax({
                    ...
                    <tr style="text-align: center">
                        <th scope="col">날씨</th>
                        <th scope="col">시간</th>
                        <th scope="col">예약현황<br>(예약건수/총자릿수)</th>
                        <th scope="col">예약바로가기</th>
                    </tr>
                    </thead>
                    <tbody >`
                        for (let i = 9; i < 24; i++) {
                            baseTable += `<tr style="text-align: center"> <td></td> <td>\${i}:00</td> <td> \${data.filter(item => getStringBeforeSymbol(item.startTime, ':') == i).length} / \${data[0].sites}</td> <td><input type="button" id="res_ch" value="예약"></td> </tr>`
                        }
                        /* if (!data) {
                             baseTable += `<tr> <td colSpan="5" style="text-align: center">오늘 예약이 없습니다.</td> </tr>`;
                         }*/
                        baseTable += `</tbody>
                </table>`
