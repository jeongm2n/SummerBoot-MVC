...
public class WeatherDAO {
	...
	public List<WeatherVO> get3Days(String today, String nx, String ny) throws IOException{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=f4CnjhqW4Ekv2mXBwujW%2BT%2BZBT9yOjcJxhMTlSaJ0VpqbC8exBnefo%2BJ2OtUbw0wjzVqiJs8jrdH2Afj75PDzg%3D%3D"); /*Service Key*/
	...
	public void getJson() throws ParseException{
		...
		JSONArray items = (JSONArray)body.get("item");
